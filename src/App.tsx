...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    posterSets: [
      ...
      {
        title: 'DREAMS AND SHADOWS OF TEH RED CHAMBER',
        subtitle: 'Illustration Interactive Mockup',
        images: [
          'https://img.heliar.top/file/1774876223560_a373b2aa6b6074f82b357901c08abf4b.jpg',
          'https://img.heliar.top/file/1774876219720_e53807aa66b183a1efeb7d90902e894b.jpg',
          'https://img.heliar.top/file/1774876239240_4d555329679e3370d5f9631fd4aaa062.jpg',
          'https://img.heliar.top/file/1774876241599_187ba3378d539b427a080174fa7b359e.jpg'
        ],
        aspect: 'aspect-[5008/7082]',
        maxWidth: 'max-w-md'
      },
      {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center py-20 select-none w-full overflow-visible">
      ...
      <div className="mt-16 flex flex-col items-center gap-6">
        ...
        <p className="text-[9px] font-mono uppercase tracking-[0.2em] text-black/30 -mt-4">
          Zoom in to view the text of the book
        </p>
      </div>
    </div>
  );
        ...
        <div className="space-y-24 md:space-y-32">
          <div className="space-y-8 text-center flex flex-col items-center">
            <div className="space-y-3">
              ...
              <div className="h-[2px] w-8 bg-black mx-auto" />
              <p className="text-[10px] font-mono tracking-[0.5em] text-black/60 uppercase">01 / Context Analysis</p>
            </div>
            <p className="text-xs leading-relaxed text-black/80 font-sans max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-black/5">
            {[
              ...
              <div key={i} className="bg-white p-10 space-y-6 hover:bg-[#f2f7b8] transition-colors cursor-default">
                ...
                <p className="text-[9px] font-mono opacity-60 uppercase tracking-widest">{item.en}</p>
                <p className="text-xs leading-relaxed text-black/80 font-sans">{item.content}</p>
              </div>
            ))}
          </div>
        </div>
              ...
              <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="p-10 border border-black/10 rounded-sm bg-white hover:bg-[#f2f7b8] text-black group transition-all duration-500 text-left cursor-default">
                    ...
                    <p className="title-card-desc group-hover:text-black/80 text-black/70 leading-relaxed">{item.c}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={i} className="flex gap-8 items-start border-b border-black/10 pb-8">
                    <span className="text-xl font-mono text-black/50">0{i+1}</span>
                    <div className="space-y-2">
                      <h5 className="title-card">{item.t}</h5>
                      <p className="title-card-desc text-black/80">{item.c}</p>
                    </div>
                  </div>
                ))}
              </div>
    ...
    >
      ...
      <AnimatePresence>
        {isHovered && (
          ...
          >
            <div className="space-y-2">
              <h3 className="text-sm font-bold uppercase tracking-tighter text-black">
                {project.title}
              </h3>
              <div className="h-[1px] w-8 bg-black mx-auto" />
              <p className="text-[13px] font-mono text-black uppercase tracking-widest leading-tight">
                {project.description}
              </p>
              <div className="pt-1">
                <span className="text-[12px] font-mono text-black tracking-widest">{project.year}</span>
              </div>
            </div>
            {/* Small arrow */}
